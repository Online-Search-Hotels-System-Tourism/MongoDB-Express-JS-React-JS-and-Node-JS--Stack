    ...
    render() {
        return <div className={'col-10 mx-auto col-md-5 mt-4'}>
            <div className={'card card-body my-3'}>
                <h3 className={'text-center mb-5'}>Add Hotel</h3>
                <form onSubmit={this.onSubmit}>
                    <div className="form-group">
                        <label>Hotel Title</label>
                        <input type="text" className="form-control" placeholder="Hotel Title" value={this.state.title} onChange={this.onChangeProductTitle}/>
                    </div>
                    <div className="form-group">
                        <label>Hotel Description</label>
                        <textarea className="form-control" placeholder="Hotel Description" value={this.state.description} onChange={this.onChangeProductDescription}/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <label>Price in LKR one day</label>
                    ...
                    <div className="form-group">
                        <label>Rooms</label>
                        <input type="number" className="form-control" placeholder="How many rooms" value={this.state.stockAmount} onChange={this.onChangeProductStockAmount}/>
                    </div>
                    <div className="form-group">
